#!/bin/env bash
set -e 
# Kyli0x's Arch + Dwm + Polybar dotfile rice installation script
# By me.. Kyli0x!!
# License: GNU GPLv3
...
CYAN "Kyli0x's Arch (with dwm+polybar) install script, Hope you enjoy!"
...
git clone https://github.com/kyli0x/suckless.git ~/.config/ && sudo make clean install -C ~/.config/suckless/dwm/
sleep 5
